package com.smartfoxserver.v2.entities
{
   ...
   public class SFSBuddy implements Buddy
   {
      ...
      {
         var buddy:Buddy = new SFSBuddy(arr.getInt(0),arr.getUtfString(1),arr.getBool(2),arr.size() > 3 ? Boolean(arr.getBool(4)) : Boolean(false));
      ...
      public function get isOnline() : Boolean
      {
         ...
         var onlineStateVar:Boolean = bv == null ? Boolean(true) : Boolean(bv.getBoolValue());
